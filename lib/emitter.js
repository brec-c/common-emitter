(function() {
  var Emitter, isNodeJS, _,
    __slice = Array.prototype.slice;

  isNodeJS = require('detectify').isNodeJS;

  if (isNodeJS) return module.exports = require('events').EventEmitter;

  _ = window['_'];

  if (_ == null) _ = require('underscore');

  if (_ == null) throw new Error("Underscore library required for Browser use.");
